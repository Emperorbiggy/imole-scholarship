            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4 relative overflow-hidden">
                ...
                <div className="relative w-full max-w-md">
                    ...
                    <div className="relative bg-white/[0.04] backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-2xl">
                        ...
                        {status && (
                            <div className="mb-6 px-4 py-3 rounded-xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 text-sm">
                                {status}
                            </div>
                        )}
                            ...
                            <div className="flex items-center justify-between">
                                <label className="flex items-center gap-2 cursor-pointer select-none">
                                    <input
                                        ...
                                        className="w-4 h-4 rounded border-white/20 bg-white/5 text-amber-400 focus:ring-amber-400/30"
                                    />
                    ...
                    <p className="text-center text-slate-700 text-xs mt-6">
                        &copy; 2026 Imole Award. Restricted access.
                    </p>
                </div>
            </div>
        </>
