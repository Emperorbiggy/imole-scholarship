...
export default function PublicSchool() {
    ...
    function handleSubmit(e) {
        ...
        if (!data.school_account_name.trim()) { setError('school_account_name', 'Please complete account verification.'); hasError = true; }
            ...
            <FormLayout title="Schools" subtitle="Public" accentColor="blue" backLabel="← Back to Portal">
                ...
                <form onSubmit={verifyCode} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full bg-white/5 border rounded-xl px-4 py-3 text-white text-center text-xl font-mono font-bold tracking-widest placeholder-slate-600 focus:outline-none focus:ring-1 transition-all ${
                                codeError ? 'border-red-500/50 focus:ring-red-500/20' : 'border-white/10 focus:border-blue-400/50 focus:ring-blue-400/20'
                            }`}
                        />
                        {codeError && (
                    ...
                    <button
                        ...
                        className="w-full py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-500 hover:to-indigo-400 text-white font-bold text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-500/20"
                    >
                        {codeChecking ? (
    ...
    return (
        <FormLayout title="Schools" subtitle="Public" accentColor="blue" backLabel="← Back to Portal">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <FormField label="Surname" error={errors.surname} required>
                                <Input type="text" placeholder="Surname" value={data.surname}
                                    onChange={e => setData('surname', e.target.value)} />
                            </FormField>
                            <FormField label="First Name" error={errors.first_name} required>
                                <Input type="text" placeholder="First name" value={data.first_name}
                                    onChange={e => setData('first_name', e.target.value)} />
                            </FormField>
                        </div>

                        <FormField label="Middle Name" error={errors.middle_name}>
                            <Input type="text" placeholder="Middle name (optional)" value={data.middle_name}
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <BankAccountField
                            ...
                            errors={{ account_number: errors.school_account_number, account_name: errors.school_account_name, bank: errors.bank }}
                            accentColor="blue"
                            accountNumberLabel="School Account Number"
                            accountNameLabel="School Account Name"
                            onResolvingChange={setBankResolving}
                            registrationType="public_school"
                ...
                <div className="pt-4">
                    <SubmitButton accentColor="blue" loading={processing} disabled={processing || bankResolving || accountDuplicate}>
                ...
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-sm bg-slate-900 border border-yellow-500/30 rounded-2xl p-6 shadow-2xl">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button type="button" onClick={() => { setSchoolMismatch(false); setSchoolMismatchSeen(true); post(route('register.public_school.store')); }}
