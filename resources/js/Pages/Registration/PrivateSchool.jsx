    ...
    return (
        <FormLayout title="Schools" subtitle="Private" accentColor="violet" backLabel="← Back to Portal">
            <p className="text-slate-400 text-sm mb-8 text-center">
                Fill in all fields accurately. Upload your most recent Harmonized Bill Payment document.
            </p>
                ...
                <div className="pb-4 border-b border-white/10">
                    ...
                    <div className="space-y-4">
                        ...
                        <FormField label="School Name" error={errors.school} required>
                            <Input
                                type="text"
                                placeholder="Official name of the private school"
                                value={data.school}
                                onChange={e => {
                ...
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-sm bg-slate-900 border border-yellow-500/30 rounded-2xl p-6 shadow-2xl">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                type="button"
                                onClick={() => { setSchoolMismatch(false); setSchoolMismatchSeen(true); post(route('register.private_school.store'), { forceFormData: true }); }}
